          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                    <td>
                      <a href="{{ route('car.show', $car->id) }}">
                        <x-img src="{{ $car->primaryImage->image_path }}" alt="" class="my-cars-img-thumbnail" />
                      </a>
                    </td>
                    <td><a href="{{ route('car.show', $car->id) }}">{{ $car->title }}</a></td>
                ...
                @empty
                <tr>
                  <td colspan="6" class="text-center">No cars found, <a href="{{ route('car.create') }}">create new car</a></td>
                </tr>
                @endforelse
              </tbody>
            </table>
